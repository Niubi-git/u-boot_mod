...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("=/home/pep/Hacking/niubi/freshlibrecmc/staging_dir/toolchain-mips_24kc_gcc-5.4.0_musl-1.1.16/mips-openwrt-linux-musl/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
