/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/pep/Hacking/niubi/freshlibrecmc/build_dir/toolchain-mips_24kc_gcc-5.4.0_musl-1.1.16/gcc-5.4.0/gcc/config/mips/mips.md'.  */
...
{
  if (c >= CONSTRAINT_G && c <= CONSTRAINT_YB)
    return;
  if (c >= CONSTRAINT_ks && c <= CONSTRAINT_ks)
    {
      *allows_reg = true;
      return;
    }
